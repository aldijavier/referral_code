...
<section class="content card" style="padding: 10px 10px 10px 10px ">
    <div class="box">
        ...
        @endif
        <form action="/referral/referralagent/{{$suratkeluar->id}}/update" method="POST" enctype="multipart/form-data">
            ...
            <a class="btn btn-danger btn-sm" href="/referral/referralagent/index" role="button"><i class="fas fa-undo"></i>
                BATAL</a>
        </form>
    </div>
</section>
